...
def _system_prompt() -> str:
    return (
        ...
        "3. To order food: search restaurants, load that restaurant's menu, add real menu "
        "items to the cart, then call food_place_order. For groceries: search products, add "
        "to cart, then im_checkout. For a table: search Dineout, check availability, then "
        "dineout_book_table. Do not re-read the cart more than once before ordering.\n"
